...
import com.example.cyber_securty.databinding.FragmentLessonTwoBinding
...
class LessonTwoFragment : Fragment() {
    private lateinit var binding: FragmentLessonTwoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLessonTwoBinding.inflate(layoutInflater)
    ...
    override fun onResume() {
        super.onResume()
        list = LoadList.loadList12() as ArrayList<StoryData>
        addView(list[count])
        onBackPressed()
        ...
        binding.next.setOnClickListener {
            ...
            findNavController().navigate(R.id.lessonThreeFragment)
        }
    ...
    private fun addView(title: StoryData) {
        music.stop()
        ...
        onBackPressed()
        music = MediaPlayer.create(requireContext(), Uri.parse(title.audioUrl))
        music.start()
        textView.text = title.audioText
