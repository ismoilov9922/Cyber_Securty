...
class LessonThreeFragment : Fragment() {
    private lateinit var binding: FragmentLessonThreeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLessonThreeBinding.inflate(layoutInflater)
    ...
    override fun onResume() {
        ...
        binding.next.setOnClickListener {
            ...
            findNavController().navigate(R.id.lessonFourFragment)
        }
