...
import com.example.cyber_securty.databinding.FragmentLessonFiveBinding
...
class LessonFiveFragment : Fragment() {
    private lateinit var binding: FragmentLessonFiveBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLessonFiveBinding.inflate(layoutInflater)
    ...
    override fun onResume() {
        ...
        binding.share.setOnClickListener {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "KiberXafsizlik")
            intent.putExtra(
                Intent.EXTRA_TEXT,
